...
public class Processor {
	...
	public Processor(int sizei,int Latencyi,int sized,int Latencyd)
	{
		registerFile = new RegisterFile();
		mainMemory = new MainMemory();
		cacheL1i = new Cache(this,Latencyi,sizei);
		cacheL1d = new Cache(this,Latencyd,sized);		
		...
		IFUnit = new InstructionFetch(this, IF_EnableLatch, IF_OF_Latch, EX_IF_Latch, EX_MA_Latch, OF_EX_Latch, MA_RW_Latch);
		...
		MAUnit = new MemoryAccess(this, EX_MA_Latch, MA_RW_Latch, IF_OF_Latch, IF_EnableLatch, OF_EX_Latch);
		RWUnit = new RegisterWrite(this, MA_RW_Latch, IF_EnableLatch, IF_OF_Latch, EX_MA_Latch, OF_EX_Latch );
	}
	...
	public Cache getCacheL1i() {
		return cacheL1i;
	}

	public void setCacheL1i(Cache cacheL1i) {
		this.cacheL1i = cacheL1i;
	}
	public Cache getCacheL1d() {
		return cacheL1d;
	}
	public void setCacheL1d(Cache cacheL1d) {
		this.cacheL1d = cacheL1d;
	}
